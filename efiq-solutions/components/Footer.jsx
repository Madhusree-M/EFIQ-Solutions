...
function PrivacyPolicyModal({ onClose }) {
    return (
        ...
        >
            <div
                className="relative bg-[#1a1a1a] rounded-2xl w-full max-w-2xl max-h-[85vh] flex flex-col shadow-2xl border border-white/10"
            ...
            >
                ...
                <div className="flex items-center justify-between px-8 pt-7 pb-4 border-b border-white/10 shrink-0">
                    ...
                    <div className="flex items-center gap-4">
                        <span className="text-white/50 text-xs">Last Updated: 05.12.2025</span>
                        <button
                            onClick={onClose}
