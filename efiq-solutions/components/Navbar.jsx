        ...
        >
            <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <div className="hidden md:block">
                    <Link
                        href="#contact"
                        className="px-5 py-2 bg-[#22C55E] hover:bg-[#16a34a] text-black text-sm font-semibold rounded-md transition-all duration-200 hover:scale-105 hover:shadow-[0_0_20px_rgba(34,197,94,0.4)]"
                    >
                        Get in Touch
                    </Link>
                </div>
