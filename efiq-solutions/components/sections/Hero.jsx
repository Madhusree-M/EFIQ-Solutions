...
export default function Hero() {
    return (
        ...
        >
            ...
            {/* Content wrapper */}
            <div className="relative z-10 flex flex-col w-full h-full max-w-7xl mx-auto px-10 md:pl-10">
                ...
                <div className="w-full z-20 flex flex-col justify-center pt-24 sm:pt-28 md:pt-32 lg:pt-32 xl:pt-40">
                    <motion.h1
                        ...
                        className="flex flex-col gap-2 items-start lg:gap-0 font-bold leading-[1.12] text-white mb-5 sm:mb-4 lg:mb-6 drop-shadow-lg"
                        style={{
            ...
            <motion.div
                ...
                className="absolute bottom-0 inset-x-0 lg:inset-x-auto lg:right-[6%] w-full sm:w-[80%] md:w-[65%] lg:w-[60%] h-[60%] sm:h-[55%] lg:h-[85%] md:bottom-[-5%] lg:bottom-[-2%] mx-auto lg:mx-0 flex items-end justify-center lg:justify-end z-10 pointer-events-none"
            >
                <div className="relative w-full h-full flex justify-center lg:justify-end items-end">
                    <img
                        ...
                        className="w-full h-full object-contain object-bottom lg:object-right-bottom drop-shadow-[0_0_30px_rgba(10,132,255,0.3)] md:scale-[1.2] lg:scale-[1.4]"
                    />
                    {/* Subtle glow */}
